...
namespace SrvAppCargasSisbol.Data.Models
{
    public class Folha5Frente
    {
        ...
        private string? _sit_med;
        private string? _sit_odont;
        ...
        public string? sit_med
        {
            ...
            set
            {
                ...
                else { _sit_med = value?.Replace("'", " "); }
            }
        }
        public string? sit_odont
        {
            get => _sit_odont;
            set
            {
